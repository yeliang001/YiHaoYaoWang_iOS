...
@class SendValidCodeForPhoneRegisterResult;
@class CheckValidCodeForPhoneRegisterResult;
@class BindMobileResult;
@class SendBindValidateCodeResult;
@class MobilePromotion;
@class SearchParameterVO;
@class SaveGoodReceiverResult;
#pragma mark - 获得单例
...
// 获取2，3级分类
-(NSArray*)getCategoryByRootCategoryId:(Trader*)trader
                              mcsiteId:(NSNumber*)mcsiteId
                        rootCategoryId:(NSNumber*)rootCategoryId;
//取得首页的热销图(废弃)
...
//结算中心提交订单
-(long long int)submitOrder:(NSString *)token;
...
#pragma mark 获取商品详情页促销活动（包含赠品、换购、满减）
...
#pragma mark  根据搜索条件查询商品列表、筛选条件（包括品牌、导购属性、价格区间）、促销活动ID

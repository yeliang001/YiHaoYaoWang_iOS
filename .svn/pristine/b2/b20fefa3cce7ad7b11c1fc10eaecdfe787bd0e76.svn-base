...
@class CityVO;
@class CountyVO;
@interface OtspOrderConfirmVC :BaseViewController<UIPickerViewDelegate,UIPickerViewDataSource>
{
    ...
    IBOutlet UILabel * mDeliverDayLabel;
    IBOutlet UILabel * mDeliverWeightLabel;
...
@property(retain)OrderVO * currentOrder;

...
@property(copy,nonatomic)NSString * oprCreatetime;
@property(copy,nonatomic)NSString * oprUpdatetime;
@property(copy,nonatomic)NSString * oprContent;
@property(copy,nonatomic)NSString * oprOperator;
@property(copy,nonatomic)NSString * oprPreEvent;
@property(copy,nonatomic)NSString * oprEvent;
@property(copy,nonatomic)NSString * oprRemark;

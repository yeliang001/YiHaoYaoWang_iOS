...
-(IBAction)scanBtnClicked:(id)sender
{
    ...
    [[SharedDelegate homePage] pushVC:scan animated:YES];
}
...
//    NSArray *tempArray=[[OTSServiceHelper sharedInstance] getSearchKeyword:[GlobalValue getGlobalValueInstance].trader mcsiteId:[NSNumber numberWithInt:1] keyword:m_KeyWord provinceId:[GlobalValue getGlobalValueInstance].provinceId];
...
- (void)searchBarSearchButtonClicked:(UISearchBar *)searchBar
{
    ...
    else
    {
        ...
        //百分点
        [BfdAgent search:nil queryString:m_KeyWord options:nil];
    }
}
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	if (tableView==m_SearchRelationTableView)
    {
        ...
        else
        {
			...
			[[cell textLabel] setFont:[UIFont systemFontOfSize:15.0]];
//			[[cell detailTextLabel] setText:[NSString stringWithFormat:@"约%@条商品",[keyWordVO resultCount]]];

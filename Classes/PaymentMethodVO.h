...
@private
    ...
    PaymentMethodError *errorInfo; // 不支持货到付款的原因
    NSString * isSupport; // 是否支持货到付款. 0为不支持，1为支持
}
...
@property(retain,nonatomic)PaymentMethodError *errorInfo;
@property(retain,nonatomic)NSString * isSupport;
@end

...
@private NSString * hasCash;                    //满减
@private NSString * hasRedemption;              //换购
}
...
@property(retain,nonatomic) NSString * hasCash;
@property(retain,nonatomic) NSString * hasRedemption;              

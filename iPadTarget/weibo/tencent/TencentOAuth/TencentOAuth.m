...
- (BOOL)getUserInfo
{
	...
	APIBase *apiRequest = [[[APIBase alloc] initWithTarget:self andSelector:@selector(getUserInfoResponse:) andHttpMethod:@"GET"] autorelease];
...
- (BOOL)getListAlbum
{
	...
	NSMutableDictionary * params = [NSMutableDictionary dictionary];
	APIBase *apiRequest = [[[APIBase alloc] initWithTarget:self andSelector:@selector(getListAlbumResponse:) andHttpMethod:@"GET"] autorelease];
...
- (BOOL)getListPhotoWithParams:(NSMutableDictionary *)params
{
	...
	APIBase *apiRequest = [[[APIBase alloc] initWithTarget:self andSelector:@selector(getListPhotoResponse:) andHttpMethod:@"GET"] autorelease];
...
- (BOOL)addShareWithParams:(NSMutableDictionary *)params
{
	...
	APIBase *apiRequest = [[[APIBase alloc] initWithTarget:self andSelector:@selector(addShareResponse:) andHttpMethod:@"POST"] autorelease];
...
- (BOOL)uploadPicWithParams:(NSMutableDictionary *)params
{
	...
	APIBase *apiRequest = [[[APIBase alloc] initWithTarget:self andSelector:@selector(uploadPicResponse:) andHttpMethod:@"POST"] autorelease];
...
- (BOOL)addOneBlogWithParams:(NSMutableDictionary *)params
{
	...
	APIBase *apiRequest = [[[APIBase alloc] initWithTarget:self andSelector:@selector(addOneBlogResponse:) andHttpMethod:@"POST"] autorelease];
...
-(BOOL)checkPageFansWithParams:(NSMutableDictionary *)params
{
	...
	APIBase *apiRequest = [[[APIBase alloc] initWithTarget:self andSelector:@selector(checkPageFansResponse:) andHttpMethod:@"GET"] autorelease];
...
- (BOOL)addTopicWithParams:(NSMutableDictionary *)params
{
	...
	APIBase *apiRequest = [[[APIBase alloc] initWithTarget:self andSelector:@selector(addTopicResponse:) andHttpMethod:@"POST"] autorelease];

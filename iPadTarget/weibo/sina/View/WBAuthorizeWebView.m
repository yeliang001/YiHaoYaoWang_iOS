...
//        panelView = [[UIView alloc] initWithFrame:CGRectMake(10, 30, 300, 440)];
        panelView = [[UIView alloc] initWithFrame:CGRectMake(10, 30, 1024, 768)];
...
//        containerView = [[UIView alloc] initWithFrame:CGRectMake(10, 10, 280, 420)];
        containerView = [[UIView alloc] initWithFrame:CGRectMake(10, 10, 1024, 768)];
...
//        webView = [[UIWebView alloc] initWithFrame:CGRectMake(0, 0, 280, 390)];
        ...
        // add close btn
        UIButton* closeBTN = [[UIButton alloc] initWithFrame:CGRectMake(930,7 ,40, 40)];
        [closeBTN setImage:[UIImage imageNamed:@"close"] forState:UIControlStateNormal];
        [closeBTN addTarget:nil action:@selector(onCloseButtonTouched:) forControlEvents:UIControlEventTouchUpInside];
...
//        [indicatorView setCenter:CGPointMake(240, 160)];
        ...
        [panelView setFrame:CGRectMake(10, 30, 1004, 728)];
        [containerView setFrame:CGRectMake(10, 10, 984, 708)];
        [webView setFrame:CGRectMake(0, 0, 984, 708)];
        [indicatorView setCenter:CGPointMake(512, 384)];
...
//        [indicatorView setCenter:CGPointMake(160, 240)];
        ...
        [panelView setFrame:CGRectMake(10, 30, 748, 984)];
        [containerView setFrame:CGRectMake(10, 10, 728, 964)];
        [webView setFrame:CGRectMake(0, 0, 728, 964)];
        [indicatorView setCenter:CGPointMake(384, 512)];
    }

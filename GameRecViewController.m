...
//    rec.postImg=productImg;
    self.gameFinishVC.postText=[NSString stringWithFormat:@"我壮烈献声给你换来的1号药店的免费礼包，快去抢"];
...
-(void)sendSMS:(NSString*)content{
    ...
    controller.body = [NSString stringWithFormat:@"我壮烈献声给你换来的1号药店的免费礼包，快去抢！http://m.yihaodian.com/mw/guess/%@",content];

...
- (id)init
{
    if (self = [super initWithFrame:CGRectMake(0, 0, 320, 480)])
    {
        ...
        [[panelView layer] setCornerRadius:0.0];
        [self addSubview:panelView];
         
        
        // add the conainer view
        
        containerView = [[UIView alloc] initWithFrame:CGRectMake(5, 10, 320, 420)];
        ...
        closeBTN = [[UIButton alloc] initWithFrame:CGRectMake(297,7 ,20, 20)];
        [closeBTN setImage:[UIImage imageNamed:@"close"] forState:UIControlStateNormal];
        
        [closeBTN addTarget:nil action:@selector(closeBtnClick:) forControlEvents:UIControlEventTouchUpInside];
        ...
        [closeBTN bringSubviewToFront:containerView];
...
- (void)sizeToFitOrientation:(UIInterfaceOrientation)orientation
{
    ...
    else
    {
        ...
        [containerView setFrame:CGRectMake(0, 10, 320, 420)];
        [webView setFrame:CGRectMake(0, 0, 320, 420)];
        [indicatorView setCenter:CGPointMake(160, 240)];
    }
...
{
    [[OTSUnionLoginHelper sharedInstance] handleSinaLoginWithWebView:aWebView];
...
- (BOOL)webView:(UIWebView *)aWebView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType
{
    ...
    if (range.location != NSNotFound)
    {
        ...
        {
            [[OTSUnionLoginHelper sharedInstance] saveSinaUserNameFromWebView:webView];
